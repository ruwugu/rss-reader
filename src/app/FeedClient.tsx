      ...
      <div className="max-w-2xl mx-auto px-4 py-2 flex gap-2">
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-sm ${
            filter === 'all' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
          }`}
        >
          全部
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-sm ${
            filter === 'unread' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
          }`}
        >
          未读
        </button>
        <button
          ...
          className={`px-4 py-1.5 rounded-full text-sm ${
            filter === 'favorite' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600'
          }`}
        >
          收藏
        </button>
