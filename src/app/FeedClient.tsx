...
const TWITTER_FEEDS = [
  ...
  { id: 'twitter-elonmusk', name: 'Elon Musk', twitter_handle: 'elonmusk', url: `${TWITTER_RSSHUB}/user/elonmusk`, avatar: 'https://pbs.twimg.com/profile_images/1590289135619338240-p8lP4_r_.jpg', description: 'Tesla, SpaceX, X' },
  ...
  { id: 'twitter-demis', name: 'Demis Hassabis', twitter_handle: 'demishassabis', url: `${TWITTER_RSSHUB}/user/demishassabis`, avatar: 'https://pbs.twimg.com/profile_images/1553175885/demis_avatar_200x200.jpg', description: 'Google DeepMind' },
  { id: 'twitter-jeffdean', name: 'Jeff Dean', twitter_handle: 'JeffDean', url: `${TWITTER_RSSHUB}/user/JeffDean`, avatar: 'https://pbs.twimg.com/profile_images/1221600828702249473/2d_Tx4Ag.jpg', description: 'Google AI' },
  { id: 'twitter-hwchase17', name: 'Chase', twitter_handle: 'hwchase17', url: `${TWITTER_RSSHUB}/user/hwchase17`, avatar: 'https://pbs.twimg.com/profile_images/1777620652245245952/lN-UrS7-.jpg', description: 'LangChain' },
